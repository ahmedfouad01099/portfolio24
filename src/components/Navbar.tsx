...
import NavLogo from "../../public/assets/infinova-favicon-black.png";
...
const Navbar = () => {
	...
	return (
		<div
			...
			className={
				shadow
					? "pt-4 fixed w-full h-24 shadow-xl z-[100] ease-in-out duration-300"
					: "pt-4 fixed w-full h-24 z-[100]"
			}
		>
